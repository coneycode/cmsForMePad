...
class ContentModel extends Model {
    ...
    protected $_auto = array (
        ...
        array('create_time','strtotime',3,'function'), //时间
        array('update_time','strtotime',3,'function'), //时间
        array('status','intval',3,'function'), //状态
        array('sequence','intval',3,'function'), //顺序
        array('downloads','intval',3,'function'), //访问量
        ...
        array('special','formatSpecial',3,'callback'), //专题
        //编辑
    ...
    public function getWhereInfo($where){
        return $this->table("__CONTENT__ as A")
                    ...
                    // ->field('A.*,B.name as class_name,B.app,B.urlname as class_urlname,B.image as class_image')
                     ->field('A.*,B.name as class_name,B.image as class_image')
                    ->where($where)
                    ->find();
    }
